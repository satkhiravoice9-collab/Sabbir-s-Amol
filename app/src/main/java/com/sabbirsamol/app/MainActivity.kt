...
class MainActivity : Activity() {
    ...
    private fun showManzilPdfScreen() {
        ...
        val manzilAyats = listOf(
            "১. সূরা আল-ইনশিকাক (১-২৫)" to "بِسْمِ اللهِ الرَّحْمَنِ الرَّحِيمِ\nإِذَا السَّمَاءُ انْشَقَّتْ ، وَأَذِنَتْ لِرَبِّهَا وَحُقَّتْ ، وَإِذَا الْأَرْضُ مُদَّتْ وَأَلْقَتْ مَا فِيهَا وَتَخَلَّتْ ، وَأَذِنَتْ لِرَبِّهَا وَحُقَّتْ ، يَأَيُّهَا الْإِنْسَانُ إِنَّكَ كَادِحٌ إِلَى رَبِّكَ كَدْحًا فَمُلَقِيهِ...",
            ...
            "৪. সূরা আলে ইমরান, আল-আ'রাফ ও আল-ইসরা" to "শহিদাল্লাহু আন্নাহু লা ইলাহা ইল্লা হুয়া ওয়াল মালাইকাতু...\n\nইন্না রব্বাকুমুল্লাহুল্লাযী খালাকাস সামাওয়াতি ওয়াল আরদ্ব...",
            "৫. সূরা আস-সাফফাত, আল-হাশর ও আল-জিন" to "ওয়াস-সাফফাতি সফফা...\n\nলাও আনযালনা হাযাল কুরআনা আলা জাবালিল...\n\nকুল ঊহিয়া ইলাইয়া আন্নাহুস তামায়া নাফারুম মিনাল জিন..."
        )
